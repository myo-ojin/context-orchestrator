...
class TestIngestionService:
    ...
    def test_store_memory_metadata(self, service, mock_dependencies):
        ...
        # Verify embedding was generated (with enriched summary containing keywords)
        mock_dependencies['model_router'].generate_embedding.assert_called_once()
        call_args = mock_dependencies['model_router'].generate_embedding.call_args
        enriched_summary = call_args[0][0]
        # Enriched summary includes original summary and keywords
        assert memory.summary in enriched_summary
